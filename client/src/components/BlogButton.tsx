...
export function BlogButton({ heading, blogContent }: BlogButtonProps) {
  return (
    <>
      <div className="w-full mx-auto my-10 border-2 rounded-3xl border-fuchsia-300 shadow-cyan-300 shadow-lg hover:scale-101 hover:shadow-xl transition-all duration-300 ease-in-out">
